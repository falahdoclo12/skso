...
function calculateTtotal() {
    ...
    resultElement.value = t_total.toFixed(4);
}
...
function calculateTr() {
    ...
    resultElement.value = Tr.toFixed(4);
...
function saveAsPDF() {
    ...
    if (metode === "Downlink") {
        ...
        if (tTotal < tr) {
            conclusionMessage =
                "Dari hasil perhitungan total rise time budget uplink sebesar \n" +
                tTotal.toFixed(4) +
                " ns masih di bawah maksimum rise \ntime dari bit rate sinyal uplink NRZ sebesar\n" +
                tr.toFixed(4) +
                " ns. Berarti dapat disimpulkan \nbahwa sistem memenuhi rise time budget.\n";
        } else {
            conclusionMessage =
                "Dari hasil perhitungan total rise time budget uplink sebesar \n" +
                tTotal.toFixed(4) +
    ...
    datadoc = "Kesimpulan: " + conclusionMessage, margin, margin + 160;
    console.log(datadoc);
